...
const Navbar = ({
    selectedPage, setSelectedPage, isTopOfPage
}: Props) => {
    ...
    return <nav>
        ...
        >
            <div className={`${flexBetween}  mx-auto w-5/6`} >
                <div className={`${flexBetween} justify-between  w-full gap-16`}>
                    {/* Left Side */}
                    <img src={Logo} alt="Logo" />

                    {/* Right Side */}
                    {isAboveMediumScreens ? (<div className={` ${flexBetween}  justify-between  w-full `} >
